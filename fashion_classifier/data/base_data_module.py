...
from fashion_classifier.data import utils
from fashion_classifier.data.utils import BaseDataset
...
BATCH_SIZE = 128
# NUM_AVAIL_CPUS = len(os.sched_getaffinity(0))    #TODO: Fix this
NUM_AVAIL_CPUS = 4
