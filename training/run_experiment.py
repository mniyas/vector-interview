...
from fashion_classifier import lit_models
...
def main():
    ...
    Sample command:
    ```
    python training/run_experiment.py --max_epochs=3 --gpus='0,' --num_workers=20 --model_class=ResNet --data_class=FashionMNIST
    ```
    ...
    ```
    python training/run_experiment.py --model_class=ResNet --data_class=FashionMNIST --help
    """
